...
const withUpdated = (e: ReturnType<typeof gym>, updatedAt: string) => ({ ...e, updatedAt });
...
describe('mergeRemote', () => {
  ...
  it('newer remote wins; older remote is ignored', () => {
    ...
    const local = [{ ...base, rating: 1 as const, updatedAt: '2026-06-01T10:00:00Z' }];
    const newer = [{ ...base, rating: 3 as const, updatedAt: '2026-06-02T10:00:00Z' }];
    const older = [{ ...base, rating: 2 as const, updatedAt: '2026-05-30T10:00:00Z' }];
